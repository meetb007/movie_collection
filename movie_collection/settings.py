...
SECRET_KEY = \
    'django-insecure-y-!q+!y09f=xnb9yoc#)6kwcka@wcw%kq3kprftc())%^7!tr4'
...
MOVIE_API_URL = get_secret("MOVIE_API_URL")
MOVIE_API_USERNAME = get_secret("MOVIE_API_USERNAME")
MOVIE_API_PASSWORD = get_secret("MOVIE_API_PASSWORD")
